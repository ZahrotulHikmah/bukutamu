<div class="container">
    ...
    <form method="post">
        <div class="form-group form-inline">
            ...
            <a href="cetakdatatamu.php" class="btn btn-primary ml-2" target="_blank">Cetak</a>
        </div>
    </form>
            ...
            echo "<meta http-equiv='refresh' content='2;url=index.php?halaman=datatamu'>";
                ...
                while($data=mysqli_fetch_array($sql)){
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?halaman=ubahdatatamu&id=<?php echo $data['noktp'];?>" class="btn btn-info mr-2">Ubah</a>
                            <a href="index.php?halaman=hapusdatatamu&id=<?php echo $data['noktp'];?>"
